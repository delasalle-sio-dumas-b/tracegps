...
if ($pseudo == '') {
    ...
    if (strlen($pseudo) < 8 || $dao->existePseudoUtilisateur($pseudo) == false) {
        $msg = "Pseudo trop court (8 caractères minimum) ou non existant";
        ...
        if (!$succes) {
            ...
            $contenuMail .= "Votre numéro de téléphone : " . $utilisateur->getNumTel() . "\n";
